      ...
      <div className="container two-column">
        <div>
          ...
          <p className="accent-note">
            Цена, указанная на сайте в 100 000 рублей, является ориентировочной и может меняться как в меньшую, так и в большую сторону в зависимости от вашего выбора.
          </p>
